...
- `venu-pacific-services-directory` — the app itself (GTK3 via PyGObject,
  same stack and structure as `disaster-info/`)
- `venu-pacific-services-directory.desktop` — applications-menu entry
...
`venu-pacific-services` domain. The per-country content itself is
...
`.../usr/share/venu-pacific/services-directory/` — copies of the files
